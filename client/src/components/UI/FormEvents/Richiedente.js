        ...
        <h4>Richiedente</h4>
         <div>
          ...
          <div className="mb-3">
            ...
            <div className="col-sm-10">
              <input type="text" className="input-custom-style" id="inputName" {...first_name}/>
            </div>
          </div>
          <div className="mb-3">
            <label htmlFor="inputLastName" className="col-sm-2 col-form-label">Cognome</label>
            <div className="col-sm-10">
              <input type="text" className="input-custom-style" id="inputLastName" {...last_name}/>
            </div>
          </div>
          <div className="mb-3">
            <label htmlFor="inputPhone" className="col-sm-2 col-form-label">Telefono</label>
            <div className="col-sm-10">
              <input type="text" className="input-custom-style" id="inputPhone" {...phone}/>
            </div>
          </div>
    </section>
   );
